...
func (s *businessSummaryService) GetSalesTrend(period string) ([]dto.SalesTrendItem, error) {
	days := 7
	switch period {
	case "30days":
		days = 30
...
func (s *businessSummaryService) GetTopProducts(filter dto.DateRangeFilter) ([]dto.TopProductItem, error) {
...
func (s *businessSummaryService) GetTopCategories(filter dto.DateRangeFilter) ([]dto.TopCategoryItem, error) {
...
func (s *businessSummaryService) GetPaymentMethods(filter dto.DateRangeFilter) ([]dto.PaymentMethodItem, error) {
